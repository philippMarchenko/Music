...
import com.devphill.music.data.store.ReadOnlyPreferenceStore;
import com.devphill.music.data.store.RemotePreferenceStore;
...
import com.devphill.music.utils.Internal;
import com.devphill.music.utils.Util;
import com.devphill.music.utils.compat.AudioManagerCompat;
...
public class MusicPlayer implements AudioManager.OnAudioFocusChangeListener,
     ...
     */
    private static final String BROADCAST_PERMISSION = "com.devphill.music.player.BROADCAST_PERMISSION";

    /**
     * An {@link Intent} action broadcasted when a MusicPlayer has changed its state automatically
     */
    public static final String UPDATE_BROADCAST = "devphill.jockey.player.REFRESH";
     ...
     * by the user).
     */
    public static final String UPDATE_EXTRA_MINOR = "devphill.jockey.player.REFRESH:minor";
     ...
     */
    public static final String INFO_BROADCAST = "devphill.jockey.player.INFO";

    /**
     * An {@link Intent} extra sent with {@link #INFO_BROADCAST} intents which maps to a
     * user-friendly information message
     */
    public static final String INFO_EXTRA_MESSAGE = "devphill.jockey.player.INFO:MSG";
     ...
     * @see #ERROR_EXTRA_MSG
     */
    public static final String ERROR_BROADCAST = "devphill.jockey.player.ERROR";

    /**
     * An {@link Intent} extra sent with {@link #ERROR_BROADCAST} intents which maps to a
     * user-friendly error message
     */
    public static final String ERROR_EXTRA_MSG = "devphill.jockey.player.ERROR:MSG";
