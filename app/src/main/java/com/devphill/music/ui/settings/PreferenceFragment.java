...
public class PreferenceFragment extends PreferenceFragmentCompat
    ...
    private static final String DIRECTORY_FRAGMENT =
            "com.devphill.music.ui.settings.DirectoryListFragment";
    private static final String EQUALIZER_FRAGMENT =
            "com.devphill.music.ui.settings.EqualizerFragment";
    ...
    protected RecyclerView.Adapter onCreateAdapter(PreferenceScreen preferenceScreen) {
        return new PreferenceGroupAdapter(preferenceScreen) {
            ...
            public void onBindViewHolder(PreferenceViewHolder holder, int position) {
                ...
                if ("com.devphill.music.ui.settings.EqualizerFragment".equals(fragment)) {
