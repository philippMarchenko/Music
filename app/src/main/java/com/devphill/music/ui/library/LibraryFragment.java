...
public class LibraryFragment extends BaseFragment implements MaterialSearchBar.OnSearchActionListener,
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
      ...
      //  rootView =
        ...
        drawer = mBinding.getRoot().findViewById(R.id.drawer_layout);

        NavigationView navigationView = mBinding.getRoot().findViewById(R.id.nav_view);
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.nav_camera) {
                    Toast.makeText(getContext(), "nav_camera", Toast.LENGTH_SHORT).show();
                ...
                DrawerLayout drawer = (DrawerLayout) mBinding.getRoot().findViewById(R.id.drawer_layout);
